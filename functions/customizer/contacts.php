...
// --- Contacts & Social panel ---

$wp_customize->add_panel( 'sb_contacts_panel', array(
    'title' => __('Contacts & Social', 'sb-base-theme'),
    'description' => __('Contacts & Social info', 'sb-base-theme'),
    'priority' => 100,
) );
