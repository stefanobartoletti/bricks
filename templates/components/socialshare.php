<div class="elem-socialshare media py-3">
    ...
    <div class="media-body">
        ...
        foreach ($socialshare as $key => $value) { 
            ...
            if ($value['has-share'] == true) { ?>

                <a class="share-button share-<?php echo $key ?> btn btn-lg py-1 mb-1" href="<?php echo $value['share-url'] ?>" role="button" target="_blank" title="<?php echo esc_html__('Share with ', 'bricks').$value['social-name'] ?>">
